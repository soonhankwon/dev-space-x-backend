...
public class SeriesController {
    ...
    public GlobalResDto registerSeries(@Validated  @RequestBody SeriesRegisterReqDto dto, HttpServletRequest request) {
    ...
    public GlobalResDto registerSeriesContent(@PathVariable Long seriesId, @Validated @RequestBody SeriesContentRegisterReqDto dto, HttpServletRequest request) {
        User loginUser = sessionServiceImpl.getLoginUserBySession(request);
    ...
    public GlobalResDto updateSeries(@PathVariable Long seriesId, @Validated @RequestBody SeriesUpdateReqDto dto, HttpServletRequest request) {
        User loginUser = sessionServiceImpl.getLoginUserBySession(request);
